...
This package provides scale functions which can be added directly to a 
...
Colors to use can be manually assigned using `scale_color_gradientn()`. To access colors we can use `get_hurwitz_colors()` which is detailed below.
